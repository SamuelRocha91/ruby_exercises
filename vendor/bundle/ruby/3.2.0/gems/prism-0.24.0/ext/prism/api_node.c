...
#line 170 "api_node.c.erb"
                    assert(cast->name != 0);
                    argv[2] = rb_id2sym(constants[cast->name - 1]);
...
#line 195 "api_node.c.erb"
                    ...
                    // name
                    argv[2] = cast->name == 0 ? Qnil : rb_id2sym(constants[cast->name - 1]);
...
#line 170 "api_node.c.erb"
                    ...
                    argv[5] = rb_id2sym(constants[cast->read_name - 1]);

                    // write_name
#line 170 "api_node.c.erb"
                    assert(cast->write_name != 0);
                    argv[6] = rb_id2sym(constants[cast->write_name - 1]);
...
#line 170 "api_node.c.erb"
                    assert(cast->name != 0);
                    argv[4] = rb_id2sym(constants[cast->name - 1]);
...
#line 170 "api_node.c.erb"
                    assert(cast->operator != 0);
                    argv[5] = rb_id2sym(constants[cast->operator - 1]);
...
#line 158 "api_node.c.erb"
                    ...
                    // operator_loc
#line 186 "api_node.c.erb"
                    argv[4] = cast->operator_loc.start == NULL ? Qnil : pm_location_new(parser, cast->operator_loc.start, cast->operator_loc.end);
...
#line 176 "api_node.c.erb"
                    ...
                    for (size_t index = 0; index < cast->locals.size; index++) {
                        assert(cast->locals.ids[index] != 0);
                        rb_ary_push(argv[6], rb_id2sym(constants[cast->locals.ids[index] - 1]));
                    }
...
#line 144 "api_node.c.erb"
                case PM_FLOAT_NODE: {
                    ...
                    rb_ary_push(value_stack, rb_class_new_instance(2, argv, rb_cPrismFloatNode));
                    break;
                }
#line 144 "api_node.c.erb"
                case PM_FOR_NODE: {
...
#line 170 "api_node.c.erb"
                    assert(cast->operator != 0);
                    argv[8] = rb_id2sym(constants[cast->operator - 1]);
...
#line 195 "api_node.c.erb"
                    ...
                    rb_ary_push(value_stack, rb_class_new_instance(3, argv, rb_cPrismIntegerNode));
                    break;
                }
#line 144 "api_node.c.erb"
                case PM_INTERPOLATED_MATCH_LAST_LINE_NODE: {
...
#line 186 "api_node.c.erb"
                    ...
                    rb_ary_push(value_stack, rb_class_new_instance(5, argv, rb_cPrismInterpolatedStringNode));
                    break;
                }
#line 144 "api_node.c.erb"
                case PM_INTERPOLATED_SYMBOL_NODE: {
...
#line 170 "api_node.c.erb"
                    assert(cast->name != 0);
                    argv[6] = rb_id2sym(constants[cast->name - 1]);
...
#line 144 "api_node.c.erb"
                case PM_SOURCE_FILE_NODE: {
                    ...
                    // filepath
#line 167 "api_node.c.erb"
                    argv[1] = pm_string_new(&cast->filepath, encoding);

                    // location
                    argv[2] = pm_location_new(parser, node->location.start, node->location.end);

                    rb_ary_push(value_stack, rb_class_new_instance(3, argv, rb_cPrismSourceFileNode));
                    break;
                }
#line 144 "api_node.c.erb"
...
#line 158 "api_node.c.erb"
                    ...
                    rb_ary_push(value_stack, rb_class_new_instance(5, argv, rb_cPrismWhenNode));
                    break;
                }
#line 144 "api_node.c.erb"
                case PM_WHILE_NODE: {
